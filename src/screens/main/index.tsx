    ...
    return (
        <View style={{ flex: 2, backgroundColor: "black" }}>
            ...
            <View style={{ flex: 1, alignItems: "center" }}>
                <TouchableOpacity style={{ marginTop: 20, width: "width: 90%", height: 100, alignItems: "center" }}>
                    ...
                    {pauseIn ?
                        <TouchableWithoutFeedback onPress={togglePaused}>
                            <Image source={play} style={{ width: 25, height: 25, position: "absolute", marginTop: 100, marginLeft: 30 }}></Image>
                        </TouchableWithoutFeedback>
                        :
                        <TouchableWithoutFeedback onPress={togglePaused}>
                            <Image source={pause} style={{ width: 25, height: 25, position: "absolute", marginTop: 100, marginLeft: 30 }}></Image>
                        </TouchableWithoutFeedback>
                    }
                    {/* {
                        sizeIn ?
